...
<div class="relative" id="appSwitcherWrap">
    <button type="button"
            ...
            class="w-full flex items-center gap-3 px-5 py-5 border-b min-h-[68px] hover:bg-slate-50 transition-colors text-left {{ $studioChrome ? 'border-zinc-800 hover:bg-zinc-800/40' : 'border-slate-100' }}"
